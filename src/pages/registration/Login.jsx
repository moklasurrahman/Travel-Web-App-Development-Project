...
const Login = () => {
    ...
    try{
        const authDetail = {
            ...
            const data = await login(authDetail) //login geting data to "services/authService"
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handelRegisters} className="space-y-4 md:space-y-6" action="#">
                  ...
                  <button type="submit" className="w-cover text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-md text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 capitalize flex gap-2 items-center"><i className="bi bi-google text-[20px] text-[#c04c29]"></i>Log With Google</button>
